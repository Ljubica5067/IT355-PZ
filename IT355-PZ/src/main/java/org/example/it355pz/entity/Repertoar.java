...
public class Repertoar {
    ...
    public Repertoar(String film, String reziser, String zanr, Integer trajanje, Double ocena, String projekcija, Double cenaKarte, String imgRepertoar) {
        this.film = film;
    ...
    public Repertoar(Long idRepertoar, String film, String reziser, String zanr, Integer trajanje, Double ocena, String projekcija, Double cenaKarte, String imgRepertoar) {
